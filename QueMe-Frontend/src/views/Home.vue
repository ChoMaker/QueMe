...
export default {
  ...
  setup() {
    ...
    const options = [
      { label: "จองฟรี โต๊ะหลุด 20:00น. (ฟรี)", value: "option1" },
      { label: "โต๊ะหลุด 21:00น. (฿1000 ต่อโต๊ะ)", value: "option2" },
      { label: "โต๊ะหลุด 22:00น. (฿2000 ต่อโต๊ะ)", value: "option3" },
      { label: "โต๊ะหลุด 23:00น. (฿3000 ต่อโต๊ะ)", value: "option4" },
      { label: "มาตอนไหนก็ได้ (฿4500 ต่อโต๊ะ)", value: "option5" },
    ];
