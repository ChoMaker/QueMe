<template>
  ...
  <div class="flex-container">
    ...
    <div class="d-flex justify-content-between">
        <p class="d-flex align-self-center" style="margin-right: 20px;">หากไม่ต้องการสั่งอาหารล่วงหน้าสามารถคลิกปุ่ม "Next"</p>
      ...
      <div class="col-lg-6">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <th scope="row">ST03</th>
              <td>เนื้อร่องซี่โครง บาร์บีคิว</td>
              <td>349.-</td>
              <td>
                <input
                  class="form-control"
            ...
            <tr>
              <th scope="row">SY04</th>
              <td>ยำไส้กรอกหมูสับ</td>
              <td>169.-</td>
              <td>
                <input
                  class="form-control"
